...
public class SignUpController {
     ...
     */
    @PostMapping("/{itemID}")
    public Re signUp(@RequestBody Player player, @PathVariable Integer itemID) {
        ...
        try {
            mailUtil.sendHtmlEmail(player.getUserMail(), "邮箱可用性测试", "“\n" +
                    ...
                    "                                <p style=\"text-indent:2em;\">报名组别：" + (player.isGroup() ? "正式组" : "新生组") + "</p>\n" +
                    "                                <p style=\"text-indent:2em;\">参赛方式：" + (player.isStar() ? "打星参赛" : "正常参赛") + "</p>\n" +
                    "\n" +
                    "                                <p style=\"text-indent:2em;\">祝:武运昌隆</p>\n" +
                    "\n" +
                    "                                <a href=\"https://acm.gxu.edu.cn\">广西大学程序设计竞赛官方网站:https://gxucpc.gxuca.team</a>\n" +
                    "\n" +
