...
public interface NnInformationDao {
    ...
    String INSERT_COL = "school,team,member1,member2,member3,email,teacher,contestId";
    String ALL_COL = "id," + INSERT_COL;

    @Insert({"insert into", TABLE_NAME, "(", INSERT_COL, ")value(#{school},#{team},#{member1},#{member2},#{member3},#{email},#{teacher},#{contestId})"})
